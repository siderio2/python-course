...
os.system("clear")
print("Ejercicio 4")
lista_desordenada = [5, 2, 8, 1, 9, 4, 2]
lista_desordenada.sort()
print(lista_desordenada)
print("El dos aparece", lista_desordenada.count(2), "veces")
mensaje = "El siete si está" if (7 in lista_desordenada) else "No, el siete no está"
print(mensaje)
